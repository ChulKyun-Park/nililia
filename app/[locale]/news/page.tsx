...
export default async function LocalizedNewsListPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <Section spacing="tight">
      ...
      {hasFetchError ? <ErrorState title="Unable to load news" description="Please check your connection and try again." /> : null}

      {!hasFetchError && !items.length ? <EmptyState title="No news yet" description="News posts will appear here soon." /> : null}
